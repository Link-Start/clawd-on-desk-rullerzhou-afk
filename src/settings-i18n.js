...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowPetColorDesc: "Apply a color filter to the pet artwork. Default preserves the theme's original colors.",
      rowPetColorUnsupported: "This theme preserves its authored colors and does not support color filters.",
      tintNone: "Default",
    ...
    zh: {
      ...
      rowPetColor: "宠物颜色",
      rowPetColorDesc: "为桌宠素材应用颜色滤镜；默认保留主题原色。",
      rowPetColorUnsupported: "此主题保留原始配色，不支持颜色滤镜。",
      tintNone: "默认",
      tintMidnight: "🌙 午夜",
      tintGold: "🥇 金色",
      tintVaporwave: "🌸 蒸汽波",
    ...
    "zh-TW": {
      ...
      rowPetColor: "寵物顏色",
      rowPetColorDesc: "為桌寵素材套用顏色濾鏡；預設保留主題原色。",
      rowPetColorUnsupported: "此主題保留原始配色，不支援顏色濾鏡。",
      tintNone: "預設",
      tintMidnight: "🌙 午夜",
      tintGold: "🥇 金色",
      tintVaporwave: "🌸 蒸汽波",
    ...
    ko: {
      ...
      rowPetColor: "펫 색상",
      rowPetColorDesc: "펫 아트에 색상 필터를 적용합니다. 기본값은 테마의 원래 색상을 유지합니다.",
      rowPetColorUnsupported: "이 테마는 원래 색상을 유지하며 색상 필터를 지원하지 않습니다.",
      tintNone: "기본",
      tintMidnight: "🌙 미드나이트",
      tintGold: "🥇 골드",
    ...
    ja: {
      ...
      rowPetColor: "ペットの色",
      rowPetColorDesc: "ペットのアートにカラーフィルターを適用します。デフォルトではテーマ本来の色を保ちます。",
      rowPetColorUnsupported: "このテーマは本来の配色を維持するため、カラーフィルターには対応していません。",
      tintNone: "デフォルト",
      tintMidnight: "🌙 ミッドナイト",
      tintGold: "🥇 ゴールド",
