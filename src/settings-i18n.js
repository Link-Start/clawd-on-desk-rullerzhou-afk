...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      discordPresenceDesktopRequiredNote: "Requires the Discord Desktop app to be running and signed in. No bot, token, or server invite — just a public Application ID.",
      discordPresenceSetupTitle: "Setup",
      discordPresenceActivityTitle: "Activity",
      discordPresenceAppIdLabel: "Application ID",
      discordPresenceAppIdHintHtml: "Create a free app in the [Discord Developer Portal](https://discord.com/developers/applications) and paste its Application ID — no bot or token needed.",
      ...
      remoteApprovalSubtitle: "Route local permission prompts to a remote channel. Secrets stay outside prefs and the desktop bubble remains the local fallback. Telegram and Feishu are supported today.",
      ...
      telegramMigrationLoading: "Loading migration status…",
      telegramMigrationTitle: "Telegram bot transport (v0.9.0 spike)",
      telegramMigrationStateLabel: "State",
      telegramMigrationRuntimeFailedSuffix: " (runtime: failed — {reason})",
      telegramMigrationRuntimeUnknown: "unknown",
      telegramMigrationOwnerLabel: "Owner",
      telegramMigrationRunning: "running",
      telegramMigrationStopped: "stopped",
      telegramMigrationPolling: "polling",
      telegramMigrationImportFailed: "Native config import failed: {error}",
      telegramMigrationRetryImport: "Retry import",
      telegramMigrationConfigureBelow: "Configure the Telegram bot below, then choose how to run it:",
      telegramMigrationTestAndSwitch: "Test native bot and switch",
      telegramMigrationEnableLegacy: "Enable legacy sidecar",
      telegramMigrationLegacyNotRunning: "Legacy sidecar is not running.",
      telegramMigrationRetryLegacy: "Retry legacy sidecar",
      telegramMigrationNativeAvailable: "Native Telegram bot is available. Test it to switch over — legacy stays as fallback.",
      telegramMigrationTestAndSwitchShort: "Test native and switch",
      telegramMigrationLegacyActive: "Legacy sidecar is active.",
      telegramMigrationDisableApproval: "Disable Telegram approval",
      telegramMigrationWaitingTap: "Waiting for your Telegram tap… (60s timeout)",
      telegramMigrationNativeActive: "Native Telegram is active. Legacy files kept for rollback.",
      telegramMigrationRollbackToLegacy: "Roll back to legacy",
      telegramMigrationDeleteLegacyToken: "Delete legacy token file",
      telegramMigrationSwitchingToLegacy: "Switching to legacy approval…",
      telegramMigrationWorking: "Working…",
      telegramMigrationTokenAlreadyRemoved: "Telegram token file was already removed.",
      telegramMigrationTokenDeleted: "Telegram token file deleted.",
      telegramMigrationTokenDeleteFailed: "Telegram token file delete failed",
      ...
      feishuApprovalChannelName: "Feishu",
      feishuApprovalCardMissingBoth: "Save app credentials and an approver user id below to continue.",
      feishuApprovalCardMissingSecrets: "Save Feishu app credentials below to continue.",
      ...
      feishuApprovalCardStarting: "Connecting to Feishu long connection…",
      feishuApprovalCardRunning: "Feishu approval is live. Approval cards will route to your bot.",
      feishuApprovalCardFailed: "Feishu approval reported a failure. Check the message below or restart.",
      feishuApprovalStep1Title: "1. App Credentials",
      feishuApprovalSecretsLabel: "Feishu app credentials",
      feishuApprovalSecretsHintHtml: "Paste the App ID and App Secret from your Feishu self-built app. Verification Token and Encrypt Key are optional unless enabled in Feishu event settings.",
      ...
      feishuApprovalSecretsEmpty: "Enter at least one Feishu secret to update.",
      feishuApprovalSecretsSaved: "Feishu secrets saved.",
      feishuApprovalSecretsSaveFailed: "Could not save Feishu secrets.",
      feishuApprovalSecretsConfiguredLabel: "Secrets configured",
      feishuApprovalSecretsConfiguredNoMask: "(stored)",
      feishuApprovalSecretsConfiguredDesc: "Feishu app credentials are saved on disk, outside clawd-prefs.json.",
      ...
      feishuApprovalApproverLabel: "Feishu approver user id",
      feishuApprovalApproverHintHtml: "Use the same id type that your app receives in card action callbacks. For a normal bot-to-user card, open_id is usually the right choice.",
      feishuApprovalApproverPlaceholder: "e.g. ou_xxx",
      feishuApprovalApproverEmpty: "Enter the Feishu approver user id first.",
      feishuApprovalSaveApprover: "Save approver",
      feishuApprovalConfigSaved: "Feishu approval config saved.",
      feishuApprovalStep3Title: "3. Enable & Test",
      feishuApprovalToggle: "Enable Feishu approval",
      feishuApprovalToggleDesc: "When configured, actionable local permission bubbles also send an approval card to Feishu.",
      feishuApprovalConnectionTimeout: "Long connection timeout",
      feishuApprovalConnectionTimeoutDesc: "How long Clawd waits for Feishu to connect or reconnect before showing failed. The SDK can still keep reconnecting in the background.",
      feishuApprovalConnectionTimeoutOption: "{seconds}s",
      feishuApprovalTest: "Test card",
      feishuApprovalTestDesc: "Sends a standalone Feishu approval card. It is not attached to any agent permission request.",
      feishuApprovalSendTest: "Send test",
      feishuApprovalTesting: "Waiting…",
      feishuApprovalTestSent: "Feishu test completed.",
      feishuApprovalTestFailed: "Feishu test failed.",
      ...
      remoteSshFieldChainStatusline: "Chain into an existing statusline on deploy (quota only, keeps its output)",
      ...
      sessionHudSummaryQuota: "Quota: {state}",
      ...
      rowQuotaMergeSources: "Merge quota sources",
      rowQuotaMergeSourcesDesc: "One set of gauges using the freshest report from any machine. Only for the same subscription on every machine - with different accounts per machine the merged numbers would lie.",
      rowSessionHudQuota: "Show account quota",
      rowSessionHudQuotaDesc: "Compact subscription usage (5h/weekly) per source at the top of the HUD; details stay in the Dashboard.",
    ...
    zh: {
      ...
      discordPresenceDesktopRequiredNote: "需要 Discord 桌面版正在运行并已登录。无需机器人、令牌或服务器邀请——只需一个公开的 Application ID。",
      discordPresenceSetupTitle: "设置",
      discordPresenceActivityTitle: "活动",
      discordPresenceAppIdLabel: "Application ID",
      discordPresenceAppIdHintHtml: "在 [Discord 开发者门户](https://discord.com/developers/applications) 创建一个免费应用，并粘贴其 Application ID——无需机器人或令牌。",
      ...
      remoteApprovalSubtitle: "把本地权限请求路由到远程渠道。密钥不写入 prefs，本地权限气泡仍然保留作为兜底。目前支持 Telegram 和飞书。",
      telegramApprovalChannelName: "Telegram",
      ...
      telegramMigrationLoading: "正在加载迁移状态…",
      telegramMigrationTitle: "Telegram 机器人传输方式(v0.9.0 内测)",
      telegramMigrationStateLabel: "状态",
      telegramMigrationRuntimeFailedSuffix: "(运行状态：失败 — {reason})",
      telegramMigrationRuntimeUnknown: "未知",
      telegramMigrationOwnerLabel: "当前使用",
      telegramMigrationRunning: "运行中",
      telegramMigrationStopped: "已停止",
      telegramMigrationPolling: "轮询中",
      telegramMigrationImportFailed: "原生配置导入失败：{error}",
      telegramMigrationRetryImport: "重试导入",
      telegramMigrationConfigureBelow: "先在下方配置 Telegram 机器人，再选择运行方式：",
      telegramMigrationTestAndSwitch: "测试原生机器人并切换",
      telegramMigrationEnableLegacy: "启用旧版 Sidecar",
      telegramMigrationLegacyNotRunning: "旧版 Sidecar 未在运行。",
      telegramMigrationRetryLegacy: "重试旧版 Sidecar",
      telegramMigrationNativeAvailable: "原生 Telegram 机器人可用，测试后即可切换——旧版将保留作为兜底。",
      telegramMigrationTestAndSwitchShort: "测试原生并切换",
      telegramMigrationLegacyActive: "旧版 Sidecar 正在使用中。",
      telegramMigrationDisableApproval: "关闭 Telegram 审批",
      telegramMigrationWaitingTap: "等待你在 Telegram 上点击…(60秒超时)",
      telegramMigrationNativeActive: "原生 Telegram 已启用，旧版文件保留以便回滚。",
      telegramMigrationRollbackToLegacy: "回滚到旧版",
      telegramMigrationDeleteLegacyToken: "删除旧版 Token 文件",
      telegramMigrationSwitchingToLegacy: "正在切换回旧版审批…",
      telegramMigrationWorking: "处理中…",
      telegramMigrationTokenAlreadyRemoved: "Telegram Token 文件已经被删除过了。",
      telegramMigrationTokenDeleted: "Telegram Token 文件已删除。",
      telegramMigrationTokenDeleteFailed: "Telegram Token 文件删除失败",
      ...
      feishuApprovalChannelName: "飞书",
      feishuApprovalCardMissingBoth: "请先在下方保存应用凭证和审批人 user id。",
      feishuApprovalCardMissingSecrets: "请先在下方保存飞书应用凭证。",
      feishuApprovalCardMissingApprover: "请先在下方保存审批人 user id。",
      feishuApprovalCardReadyToEnable: "应用凭证和审批人都已保存，在第 3 步打开开关即可启动。",
      feishuApprovalCardStarting: "正在连接飞书长连接…",
      feishuApprovalCardRunning: "飞书审批运行中，审批卡片会发到你的机器人。",
      feishuApprovalCardFailed: "飞书审批报错，看下方信息或重启。",
      feishuApprovalStep1Title: "1. 应用凭证",
      feishuApprovalSecretsLabel: "飞书应用凭证",
      feishuApprovalSecretsHintHtml: "填写企业自建应用里的 App ID 和 App Secret。Verification Token 和 Encrypt Key 只有在飞书事件配置里开启时才需要填。",
      ...
      feishuApprovalSecretsEmpty: "请至少填写一个要更新的飞书密钥。",
      feishuApprovalSecretsSaved: "飞书密钥已保存。",
      feishuApprovalSecretsSaveFailed: "无法保存飞书密钥。",
      feishuApprovalSecretsConfiguredLabel: "密钥已配置",
      feishuApprovalSecretsConfiguredNoMask: "（已存）",
      feishuApprovalSecretsConfiguredDesc: "飞书应用凭证已保存到磁盘，不会写入 clawd-prefs.json。",
      feishuApprovalSecretsCurrent: "当前 App ID：{masked}",
      feishuApprovalReplaceSecrets: "更换密钥",
      feishuApprovalStep2Title: "2. 审批人",
      feishuApprovalApproverLabel: "飞书审批人 user id",
      feishuApprovalApproverHintHtml: "这里要和飞书卡片回调里的用户 ID 类型一致。普通机器人给用户发卡片，通常选择 open_id。",
      feishuApprovalApproverPlaceholder: "例如 ou_xxx",
      feishuApprovalApproverEmpty: "请先填写飞书审批人 user id。",
      feishuApprovalSaveApprover: "保存审批人",
      feishuApprovalConfigSaved: "飞书审批配置已保存。",
      feishuApprovalStep3Title: "3. 启用与测试",
      feishuApprovalToggle: "启用飞书审批",
      feishuApprovalToggleDesc: "配置完成后，可操作的本地权限气泡会同时发送一张飞书审批卡片。",
      feishuApprovalConnectionTimeout: "长连接超时",
      feishuApprovalConnectionTimeoutDesc: "启动或重连等待超过这个时间后显示失败；底层长连接仍会继续自动重连。",
      feishuApprovalConnectionTimeoutOption: "{seconds} 秒",
      feishuApprovalTest: "测试卡片",
      feishuApprovalTestDesc: "发送一张独立飞书审批卡片，不绑定任何 agent 权限请求。",
      feishuApprovalSendTest: "发送测试",
      feishuApprovalTesting: "等待中…",
      feishuApprovalTestSent: "飞书测试完成。",
      feishuApprovalTestFailed: "飞书测试失败。",
      ...
      remoteSshFieldChainStatusline: "部署时串联远端已有的 statusline（仅采集配额，保留其输出）",
      ...
      sessionHudSummaryQuota: "配额: {state}",
      ...
      rowQuotaMergeSources: "合并配额来源",
      rowQuotaMergeSourcesDesc: "只显示一组仪表，取所有机器中最新的上报。仅适用于所有机器用同一订阅——各机器账号不同时合并数字会失真。",
      rowSessionHudQuota: "显示账号配额",
      rowSessionHudQuotaDesc: "在 HUD 顶部按来源显示紧凑的订阅用量（5小时/每周）；详情仍在 Dashboard。",
    ...
    "zh-TW": {
      ...
      discordPresenceDesktopRequiredNote: "需要 Discord 桌面版正在執行並已登入。無需機器人、權杖或伺服器邀請——只需一個公開的 Application ID。",
      discordPresenceSetupTitle: "設定",
      discordPresenceActivityTitle: "活動",
      discordPresenceAppIdLabel: "Application ID",
      discordPresenceAppIdHintHtml: "在 [Discord 開發者入口網站](https://discord.com/developers/applications) 建立一個免費應用程式，並貼上其 Application ID——無需機器人或權杖。",
      discordPresenceAppIdPlaceholder: "例如 123456789012345678",
      ...
      remoteApprovalSubtitle: "將本機權限請求路由到遠端通道。Secrets 不會寫入 prefs，本機權限泡泡仍保留為備援。目前支援 Telegram 與 Feishu。",
      telegramApprovalChannelName: "Telegram",
      ...
      telegramMigrationLoading: "正在載入遷移狀態…",
      telegramMigrationTitle: "Telegram 機器人傳輸方式(v0.9.0 內測)",
      telegramMigrationStateLabel: "狀態",
      telegramMigrationRuntimeFailedSuffix: "(執行狀態：失敗 — {reason})",
      telegramMigrationRuntimeUnknown: "未知",
      telegramMigrationOwnerLabel: "目前使用",
      telegramMigrationRunning: "執行中",
      telegramMigrationStopped: "已停止",
      telegramMigrationPolling: "輪詢中",
      telegramMigrationImportFailed: "原生設定匯入失敗：{error}",
      telegramMigrationRetryImport: "重試匯入",
      telegramMigrationConfigureBelow: "先在下方設定 Telegram 機器人，再選擇執行方式：",
      telegramMigrationTestAndSwitch: "測試原生機器人並切換",
      telegramMigrationEnableLegacy: "啟用舊版 Sidecar",
      telegramMigrationLegacyNotRunning: "舊版 Sidecar 未在執行。",
      telegramMigrationRetryLegacy: "重試舊版 Sidecar",
      telegramMigrationNativeAvailable: "原生 Telegram 機器人可用，測試後即可切換——舊版將保留作為備援。",
      telegramMigrationTestAndSwitchShort: "測試原生並切換",
      telegramMigrationLegacyActive: "舊版 Sidecar 正在使用中。",
      telegramMigrationDisableApproval: "關閉 Telegram 審批",
      telegramMigrationWaitingTap: "等待你在 Telegram 上點擊…(60秒逾時)",
      telegramMigrationNativeActive: "原生 Telegram 已啟用，舊版檔案保留以便回滾。",
      telegramMigrationRollbackToLegacy: "回滾到舊版",
      telegramMigrationDeleteLegacyToken: "刪除舊版 Token 檔案",
      telegramMigrationSwitchingToLegacy: "正在切換回舊版審批…",
      telegramMigrationWorking: "處理中…",
      telegramMigrationTokenAlreadyRemoved: "Telegram Token 檔案已經被刪除過了。",
      telegramMigrationTokenDeleted: "Telegram Token 檔案已刪除。",
      telegramMigrationTokenDeleteFailed: "Telegram Token 檔案刪除失敗",
      ...
      remoteSshFieldChainStatusline: "部署時串接遠端既有的 statusline（僅收集配額，保留其輸出）",
      ...
      sessionHudSummaryContextUsage: "上下文: {state}",
      sessionHudSummaryQuota: "配額: {state}",
      ...
      rowQuotaMergeSources: "合併配額來源",
      rowQuotaMergeSourcesDesc: "只顯示一組儀表，取所有機器中最新的回報。僅適用於所有機器共用同一訂閱——各機器帳號不同時合併數字會失真。",
      rowSessionHudQuota: "顯示帳號配額",
      rowSessionHudQuotaDesc: "在 HUD 頂部按來源顯示精簡的訂閱用量（5小時/每週）；詳情仍在 Dashboard。",
    ...
    ko: {
      ...
      discordPresenceDesktopRequiredNote: "Discord 데스크톱 앱이 실행 중이고 로그인되어 있어야 합니다. 봇, 토큰, 서버 초대가 필요 없습니다 — 공개 Application ID만 있으면 됩니다.",
      discordPresenceSetupTitle: "설정",
      discordPresenceActivityTitle: "활동",
      discordPresenceAppIdLabel: "Application ID",
      discordPresenceAppIdHintHtml: "[Discord 개발자 포털](https://discord.com/developers/applications)에서 무료 앱을 만들고 Application ID를 붙여넣으세요 — 봇이나 토큰은 필요 없습니다.",
      ...
      remoteApprovalSubtitle: "로컬 권한 요청을 원격 채널로 라우팅합니다. Secrets는 prefs에 저장하지 않으며 데스크톱 버블은 로컬 fallback으로 유지됩니다. 현재 Telegram과 Feishu를 지원합니다.",
      telegramApprovalChannelName: "Telegram",
      ...
      telegramMigrationLoading: "마이그레이션 상태 불러오는 중…",
      telegramMigrationTitle: "Telegram 봇 전송 방식(v0.9.0 스파이크)",
      telegramMigrationStateLabel: "상태",
      telegramMigrationRuntimeFailedSuffix: " (실행 상태: 실패 — {reason})",
      telegramMigrationRuntimeUnknown: "알 수 없음",
      telegramMigrationOwnerLabel: "현재 사용 중",
      telegramMigrationRunning: "실행 중",
      telegramMigrationStopped: "중지됨",
      telegramMigrationPolling: "폴링 중",
      telegramMigrationImportFailed: "네이티브 설정 가져오기 실패: {error}",
      telegramMigrationRetryImport: "가져오기 재시도",
      telegramMigrationConfigureBelow: "아래에서 Telegram 봇을 설정한 뒤 실행 방식을 선택하세요:",
      telegramMigrationTestAndSwitch: "네이티브 봇 테스트 후 전환",
      telegramMigrationEnableLegacy: "레거시 Sidecar 사용",
      telegramMigrationLegacyNotRunning: "레거시 Sidecar가 실행되고 있지 않습니다.",
      telegramMigrationRetryLegacy: "레거시 Sidecar 재시도",
      telegramMigrationNativeAvailable: "네이티브 Telegram 봇을 사용할 수 있습니다. 테스트 후 전환하면 레거시는 폴백으로 남습니다.",
      telegramMigrationTestAndSwitchShort: "네이티브 테스트 후 전환",
      telegramMigrationLegacyActive: "레거시 Sidecar가 사용 중입니다.",
      telegramMigrationDisableApproval: "Telegram 승인 비활성화",
      telegramMigrationWaitingTap: "Telegram에서 탭하기를 기다리는 중…(60초 제한)",
      telegramMigrationNativeActive: "네이티브 Telegram이 활성화되었습니다. 레거시 파일은 롤백을 위해 유지됩니다.",
      telegramMigrationRollbackToLegacy: "레거시로 롤백",
      telegramMigrationDeleteLegacyToken: "레거시 Token 파일 삭제",
      telegramMigrationSwitchingToLegacy: "레거시 승인으로 전환 중…",
      telegramMigrationWorking: "처리 중…",
      telegramMigrationTokenAlreadyRemoved: "Telegram Token 파일이 이미 삭제되어 있습니다.",
      telegramMigrationTokenDeleted: "Telegram Token 파일이 삭제되었습니다.",
      telegramMigrationTokenDeleteFailed: "Telegram Token 파일 삭제 실패",
      ...
      remoteSshFieldChainStatusline: "배포 시 원격의 기존 statusline에 체이닝 (쿼터만 수집, 표시는 유지)",
      ...
      sessionHudSummaryQuota: "쿼터: {state}",
      ...
      rowQuotaMergeSources: "쿼터 소스 병합",
      rowQuotaMergeSourcesDesc: "모든 머신 중 가장 신선한 보고 하나로 게이지 한 세트만 표시합니다. 모든 머신이 같은 구독일 때만 켜세요 - 머신마다 계정이 다르면 병합된 숫자가 거짓이 됩니다.",
      rowSessionHudQuota: "계정 쿼터 표시",
      rowSessionHudQuotaDesc: "HUD 상단에 소스별 구독 사용량(5시간/주간)을 간결하게 표시합니다. 상세는 Dashboard에 있습니다.",
    ...
    ja: {
      ...
      discordPresenceDesktopRequiredNote: "Discord デスクトップアプリが起動・ログイン済みである必要があります。ボットやトークン、サーバー招待は不要——公開の Application ID だけで動作します。",
      discordPresenceSetupTitle: "セットアップ",
      discordPresenceActivityTitle: "アクティビティ",
      discordPresenceAppIdLabel: "Application ID",
      discordPresenceAppIdHintHtml: "[Discord Developer Portal](https://discord.com/developers/applications) で無料のアプリを作成し、その Application ID を貼り付けてください——ボットやトークンは不要です。",
      ...
      remoteApprovalSubtitle: "ローカルの権限リクエストをリモートチャンネルにルーティングします。Secrets は prefs に保存せず、デスクトップの吹き出しはローカル fallback として残ります。現在は Telegram と Feishu に対応しています。",
      telegramApprovalChannelName: "Telegram",
      ...
      telegramMigrationLoading: "移行状態を読み込み中…",
      telegramMigrationTitle: "Telegram ボット転送方式(v0.9.0 スパイク)",
      telegramMigrationStateLabel: "状態",
      telegramMigrationRuntimeFailedSuffix: "（実行状態：失敗 — {reason}）",
      telegramMigrationRuntimeUnknown: "不明",
      telegramMigrationOwnerLabel: "現在の使用状況",
      telegramMigrationRunning: "実行中",
      telegramMigrationStopped: "停止中",
      telegramMigrationPolling: "ポーリング中",
      telegramMigrationImportFailed: "ネイティブ設定のインポートに失敗しました：{error}",
      telegramMigrationRetryImport: "インポートを再試行",
      telegramMigrationConfigureBelow: "下で Telegram ボットを設定してから、実行方法を選んでください：",
      telegramMigrationTestAndSwitch: "ネイティブボットをテストして切り替え",
      telegramMigrationEnableLegacy: "レガシー Sidecar を有効化",
      telegramMigrationLegacyNotRunning: "レガシー Sidecar が実行されていません。",
      telegramMigrationRetryLegacy: "レガシー Sidecar を再試行",
      telegramMigrationNativeAvailable: "ネイティブ Telegram ボットが利用可能です。テストして切り替えると、レガシーはフォールバックとして残ります。",
      telegramMigrationTestAndSwitchShort: "ネイティブをテストして切り替え",
      telegramMigrationLegacyActive: "レガシー Sidecar が使用中です。",
      telegramMigrationDisableApproval: "Telegram 承認を無効化",
      telegramMigrationWaitingTap: "Telegram でのタップを待っています…（60秒でタイムアウト）",
      telegramMigrationNativeActive: "ネイティブ Telegram が有効です。レガシーファイルはロールバック用に保持されます。",
      telegramMigrationRollbackToLegacy: "レガシーにロールバック",
      telegramMigrationDeleteLegacyToken: "レガシー Token ファイルを削除",
      telegramMigrationSwitchingToLegacy: "レガシー承認に切り替え中…",
      telegramMigrationWorking: "処理中…",
      telegramMigrationTokenAlreadyRemoved: "Telegram Token ファイルはすでに削除されています。",
      telegramMigrationTokenDeleted: "Telegram Token ファイルを削除しました。",
      telegramMigrationTokenDeleteFailed: "Telegram Token ファイルの削除に失敗しました",
      ...
      remoteSshFieldChainStatusline: "デプロイ時にリモート既存の statusline にチェーン（クォータのみ収集、表示は維持）",
      ...
      sessionHudSummaryQuota: "クォータ: {state}",
      ...
      rowQuotaMergeSources: "クォータソースを統合",
      rowQuotaMergeSourcesDesc: "全マシン中で最も新しい報告を使い、ゲージを1セットだけ表示します。全マシンが同じサブスクリプションの場合のみ有効にしてください - マシンごとにアカウントが異なると統合された数字は不正確になります。",
      rowSessionHudQuota: "アカウントクォータを表示",
      rowSessionHudQuotaDesc: "HUD 上部にソース別のサブスクリプション使用量（5時間/週間）をコンパクトに表示します。詳細は Dashboard にあります。",
