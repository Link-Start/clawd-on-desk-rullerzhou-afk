...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowCustomToolsDiscoveryPaths: "Manual discovery path",
      rowCustomToolsDiscoveryPathsDesc: "For AI tools that are not built in yet. Add an app, file, or config folder; use semicolons for multiple paths.",
    ...
    zh: {
      ...
      rowCustomToolsDiscoveryPathsDesc: "用于尚未内置支持的 AI 工具。填写应用、文件或配置目录；多个路径用分号分隔。",
      rowCustomToolsDiscoveryPathsPlaceholder: "D:\\AI\\MyTool.exe; D:\\AI\\MyTool\\config",
    ...
    "zh-TW": {
      ...
      rowCustomToolsDiscoveryPaths: "手動偵測路徑",
      rowCustomToolsDiscoveryPathsDesc: "用於尚未內建支援的 AI 工具。填入應用程式、檔案或設定資料夾；多個路徑以分號分隔。",
      rowCustomToolsDiscoveryPathsPlaceholder: "D:\\AI\\MyTool.exe; D:\\AI\\MyTool\\config",
