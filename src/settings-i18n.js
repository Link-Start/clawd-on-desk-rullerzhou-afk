...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      feishuApprovalPlatformDesc: "Feishu (China) and Lark (International) are separate deployments on different API hosts. Pick the one your app is registered on — credentials are not interchangeable.",
      feishuApprovalPlatformFeishu: "Feishu (China)",
      feishuApprovalPlatformLark: "Lark (International)",
    ...
    zh: {
      ...
      feishuApprovalPlatformDesc: "飞书（中国）和 Lark（国际）是两套独立部署，API 域名不同。请选择你的应用所在的平台——两边的凭证不通用。",
      feishuApprovalPlatformFeishu: "飞书（中国）",
      feishuApprovalPlatformLark: "Lark（国际）",
    ...
    "zh-TW": {
      ...
      feishuApprovalPlatformLabel: "平台",
      feishuApprovalPlatformDesc: "飛書（中國）和 Lark（國際）是兩套獨立部署，API 網域不同。請選擇你的應用所在的平台——兩邊的憑證不通用。",
      feishuApprovalPlatformFeishu: "飛書（中國）",
      feishuApprovalPlatformLark: "Lark（國際）",
    ...
    ko: {
      ...
      feishuApprovalPlatformDesc: "Feishu(중국)와 Lark(글로벌)는 API 호스트가 다른 별도의 배포판입니다. 앱이 등록된 쪽을 선택하세요 — 자격 증명은 서로 호환되지 않습니다.",
      feishuApprovalPlatformFeishu: "Feishu(중국)",
      feishuApprovalPlatformLark: "Lark(글로벌)",
      feishuApprovalBrandFeishu: "Feishu",
      feishuApprovalBrandLark: "Lark",
    ...
    ja: {
      ...
      feishuApprovalPlatformDesc: "Feishu（中国）と Lark（国際版）は API ホストが異なる別々のデプロイです。アプリを登録した方を選んでください——認証情報に互換性はありません。",
      feishuApprovalPlatformFeishu: "Feishu（中国）",
      feishuApprovalPlatformLark: "Lark（国際版）",
      feishuApprovalBrandFeishu: "Feishu",
      feishuApprovalBrandLark: "Lark",
