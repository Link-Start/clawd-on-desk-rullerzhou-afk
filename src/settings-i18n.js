...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowCustomToolsDiscoveryPaths: "Third-party AI tool path",
      rowCustomToolsDiscoveryPathsDesc: "Use this only for AI tools that Clawd does not support yet. Add an executable, app folder, or config folder; separate multiple paths with semicolons.",
      rowCustomToolsDiscoveryPathsPlaceholder: "D:\\AI\\MyTool.exe; D:\\AI\\MyTool\\config",
      rowCodeBuddyCompatiblePermissionUrl: "Compatible permission Hook URL",
      rowCodeBuddyCompatiblePermissionUrlDesc: "Optional. Leave empty for Clawd's local endpoint; set an http(s) URL for compatible tools that need a custom permission hook.",
      rowCodeBuddyCompatiblePermissionUrlPlaceholder: "http://127.0.0.1:23333/permission",
    ...
    zh: {
      ...
      rowCustomToolsDiscoveryPaths: "第三方 AI 工具路径",
      rowCustomToolsDiscoveryPathsDesc: "仅用于 Clawd 尚未内置支持的 AI 工具。填写可执行文件、应用目录或配置目录；多个路径用分号分隔。",
      rowCustomToolsDiscoveryPathsPlaceholder: "D:\\AI\\MyTool.exe; D:\\AI\\MyTool\\config",
      rowCodeBuddyCompatiblePermissionUrl: "兼容工具权限 Hook URL",
      rowCodeBuddyCompatiblePermissionUrlDesc: "可选。留空时使用 Clawd 本地端点；兼容工具需要自定义权限 hook 时填 http(s) URL。",
      rowCodeBuddyCompatiblePermissionUrlPlaceholder: "http://127.0.0.1:23333/permission",
    ...
    "zh-TW": {
      ...
      rowCustomToolsDiscoveryPaths: "第三方 AI 工具路徑",
      rowCustomToolsDiscoveryPathsDesc: "僅用於 Clawd 尚未內建支援的 AI 工具。填入可執行檔、應用程式資料夾或設定資料夾；多個路徑以分號分隔。",
      rowCustomToolsDiscoveryPathsPlaceholder: "D:\\AI\\MyTool.exe; D:\\AI\\MyTool\\config",
      rowCodeBuddyCompatiblePermissionUrl: "相容工具權限 Hook URL",
      rowCodeBuddyCompatiblePermissionUrlDesc: "選填。留空時使用 Clawd 本機端點；相容工具需要自訂權限 hook 時填入 http(s) URL。",
      rowCodeBuddyCompatiblePermissionUrlPlaceholder: "http://127.0.0.1:23333/permission",
