...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      agentCustomToolsSection: "Custom tool path checks",
      ...
      rowCustomToolsDiscoveryPathsDesc: "Check executable or installation paths for tools Clawd does not support yet. A path match does not install or enable an integration.",
    ...
    zh: {
      ...
      agentCustomToolsSection: "自定义工具路径检查",
      ...
      rowCustomToolsDiscoveryPathsDesc: "检查 Clawd 尚未支持的工具可执行文件或安装路径。路径存在不代表集成已安装或启用。",
    ...
    "zh-TW": {
      ...
      agentCustomToolsSection: "自訂工具路徑檢查",
      ...
      rowCustomToolsDiscoveryPathsDesc: "檢查 Clawd 尚未支援的工具執行檔或安裝路徑。路徑存在不代表整合已安裝或啟用。",
      rowCustomToolsDiscoveryPathsPlaceholder: "例如 D:\\AI\\MyTool.exe; D:\\AI\\MyTool",
    ...
    ko: {
      ...
      agentCustomToolsSection: "사용자 지정 도구 경로 확인",
      ...
      rowCustomToolsDiscoveryPathsDesc: "Clawd가 아직 지원하지 않는 도구의 실행 파일 또는 설치 경로를 확인합니다. 경로가 있어도 통합이 설치되거나 활성화된 것은 아닙니다.",
      rowCustomToolsDiscoveryPathsPlaceholder: "D:\\AI\\MyTool.exe; D:\\AI\\MyTool",
    ...
    ja: {
      ...
      agentCustomToolsSection: "カスタムツールのパス確認",
      ...
      rowCustomToolsDiscoveryPathsDesc: "Clawd がまだ対応していないツールの実行ファイルまたはインストールパスを確認します。パスが存在しても統合がインストールまたは有効化されたことにはなりません。",
      rowCustomToolsDiscoveryPathsPlaceholder: "D:\\AI\\MyTool.exe; D:\\AI\\MyTool",
